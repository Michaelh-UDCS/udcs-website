      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            <details 
              key={index} 
              className="group border border-gold/20 bg-navy/20 backdrop-blur-sm overflow-hidden transition-colors duration-200 open:border-gold/40 open:bg-navy/30"
            >
              <summary className="w-full px-6 py-5 text-left flex justify-between items-center cursor-pointer select-none list-none [&::-webkit-details-marker]:hidden focus:outline-none focus-visible:ring-1 focus-visible:ring-gold/50">
